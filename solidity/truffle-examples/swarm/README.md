# :wrench: :construction: Testing Oraclize's Kraken Swarm Example.
...
__`❍ cd ethereum-examples/solidity/truffle-examples/swarm && npm install`__
...
[The passing tests!](swarm-tests.jpg)
